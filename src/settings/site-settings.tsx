...
export const siteSettings = {
  name: 'Walkwise',
  description: 'E-commerce template built with React, NextJS, Tailwind CSS, React-Query and TypeScript.',
  author: {
    name: 'Bilal Saidumarov',
    websiteUrl: 'https://www.crossplatdev.com',
    address: '',
  },
  logo: {
    url: '/assets/images/walkwise-logo.jpg',
    alt: 'Walkwise',
    href: '/',
    width: 80,
    height: 40,
