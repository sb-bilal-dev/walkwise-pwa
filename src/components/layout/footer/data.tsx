      ...
      lists: [
        {
          ...
          path: 'https://www.instagram.com/bilal.saidumarov/',
          icon: <IoLogoInstagram />,
        },
        {
          id: 2,
          title: 'link-twitter',
          path: 'https://twitter.com/bilalsaidumarov',
          icon: <IoLogoTwitter />,
        },
        {
          id: 3,
          title: 'link-facebook',
          path: 'https://www.facebook.com/profile.php?id=100008129718184&sk=about',
          icon: <IoLogoFacebook />,
        },
        {
          id: 4,
          title: 'link-youtube',
          path: 'https://www.youtube.com/channel/UCjj-_uwBgHiMoxljNkuFAqw',
          icon: <IoLogoYoutube />,
        },
      ],
    },
